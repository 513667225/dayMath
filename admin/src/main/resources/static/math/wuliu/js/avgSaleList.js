...
layui.use(['table', 'form','upload'], function () {
    ...
    userTable = table.render({
        elem: '#goods_table',
        id: 'taskId',
        url: '/sale/queryAbsSale',
        method: 'get',
        toolbar: '#toolbarDemo',
        cols: [[
            {type: 'checkbox'},
            {field: 'asin', title: 'ASIN', sort: true},
            {field: 'productName', title: '品名', sort: true},
            {field: 'site', title: '站点', sort: true, align: 'center'},
            {field: 'user', title: '负责人', sort: true, align: 'center'},
            {field: 'nowCountBig', title: 'FBA库存', sort: true, align: 'center'},
            {field: 'count', title: '在途库存', sort: true, align: 'center'},
            {field: 'bigDecimal', title: '平均每日销量', sort: true, align: 'center'},
            {field: 'okDay', title: '预计还可使用日期', sort: true, align: 'center'},
            {field: 'hallCount', title: '海运期间预估销量', sort: true, align: 'center'},
            {field: 'flyCount', title: '空运期间预估销量', sort: true, align: 'center'},
            {field: 'sfCount', title: '快递期间预估销量', sort: true, align: 'center'},
