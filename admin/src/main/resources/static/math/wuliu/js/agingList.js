...
layui.use(['table', 'form','upload'], function () {
    ...
    $("#downloadGoods").click(function(){
        ...
        form.attr("action","/out/downloadFile?fileName=aging.xlsx");//定义action
        $("body").append(form);
        form.submit();
    })
    ...
    $("#downloadFba").click(function(){
        ...
        form.attr("target","");
        form.attr("method","post");//提交方式为post
        form.attr("action","/sku/downloadFile?fileName=aging.xlsx");//定义action
        $("body").append(form);
        form.submit();
    })
    ...
    userTable = table.render({
        ...
        cols: [[
            {type: 'checkbox'},
            {field: 'agingId', title: 'ID'},
            {field: 'asin', title: 'asin', sort: true},
            {field: 'site', title: '站点', sort: true},
            {field: 'securityDay', title: '安全天数', sort: true, align: 'center'},
            {field: 'expressDay', title: '快递天数', sort: true, align: 'center'},
            {field: 'airDay', title: '空运天数', sort: true, align: 'center'},
            {field: 'seaDay', title: '海运天数', sort: true, align: 'center'},
