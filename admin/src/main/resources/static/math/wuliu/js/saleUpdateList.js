...
layui.use(['jquery', 'form', 'util', 'layer', 'upload','laydate'], function () {
  ...
  var end =   laydate.render({
    ...
    userTable = table.render({
        ...
        cols: [[
            {type: 'checkbox'},
            {field: 'times', title: '操作时间', sort: true,templet:function (data){
                    return formatTime(data.times);
                }},
            {field: 'user', title: '操作人', sort: true},
            {field: 'times1', title: '预估日期', sort: true, align: 'center',templet:function (data){
                    return formatDay(data.times1);
                }},
            {field: 'asin', title: 'ASIN', sort: true, align: 'center'},
            {field: 'site', title: '国家', sort: true, align: 'center'},
            {field: 'beforeVal', title: '修改前', sort: true, align: 'center'},
            {field: 'afterVal', title: '修改后', sort: true, align: 'center'},
